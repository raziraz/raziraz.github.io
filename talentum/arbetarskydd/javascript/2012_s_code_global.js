...
//var s_account="talentumdev"

var s=s_gi("talentumarbetarskyddresponsiv")
var s_t=s_gi("talentumglobal")
/************************** CONFIG SECTION **************************/
/* You may add or alter any code config here. */
s_t.charSet=s.charSet="UTF-8"
/* Conversion Config */
s_t.currencyCode=s.currencyCode="SEK"
/* Link Tracking Config */
s_t.trackDownloadLinks=s.trackDownloadLinks=true
s_t.trackExternalLinks=s.trackExternalLinks=true
s_t.trackInlineStats=s.trackInlineStats=true
s_t.linkDownloadFileTypes=s.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,wmv,pdf,doc,docx,xls,xlsx,ppt,pptx"
s_t.linkInternalFilters=s.linkInternalFilters="javascript:,arbetarskydd.se"
s_t.linkLeaveQueryString=s.linkLeaveQueryString=false
s_t.linkTrackVars=s.linkTrackVars="None"
s_t.linkTrackEvents=s.linkTrackEvents="None"
s_t.trackingServer="stats.talentum.se"
s.trackingServer="stats.arbetarskydd.se"

/* WARNING: Changing any of the below variables will cause drastic
changes to how your visitor data is collected.  Changes should only be
made when instructed to do so by your account manager.*/
s.visitorNamespace="talentum"
s_t.visitorNamespace="talentum2"
s_t.dc=s.dc=112
...
/* Set Page View Event */
s_t.events=s.events=s.events?s.events+',event2':'event2';


/* Add calls to plugins here */

/* Time parting codes */
s_t.prop15=s.prop15=s.getTimeParting('w','+1',Set_Year());
s_t.eVar15=s.eVar15=s.prop15;

s_t.prop16=s.prop16=s.getTimeParting('d','+1',Set_Year());
s_t.eVar16=s.eVar16=s.prop16;

s_t.prop17=s.prop17=s.getTimeParting('h','+1',Set_Year());
s_t.eVar17=s.eVar17=s.prop17;
 
 
if(!s.eVar1)
{
s_t.eVar1=s.eVar1 = s.getQueryParam("intcmp")
}
if(!s.campaign)
{
s_t.campaign=s.campaign = s.getQueryParam("extcmp")
s_t.campaign=s.campaign = s.getValOnce(s.campaign,'s_campaign',0)
s_t.prop5=s.prop5 = s.campaign
}
if(!s.eVar8){
s_t.eVar8=s.eVar8 = s.getQueryParam("tag")
}
}
...
/* Plugin Config t*/
s_t.usePlugins=true
function s_t_doPlugins(s_t) {
	/* Add calls to plugins here */
}
s_t.doPlugins=s_t_doPlugins
...
+"dc=new Date('6/16/1910');bd=dc.getDay();bm=dc.getMonth();"
